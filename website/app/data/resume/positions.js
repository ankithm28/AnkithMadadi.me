const positions = [{
  company: 'Beroundup LLC',
  position: 'Software Engineer/Mobile Developer',
  link: 'https://beroundup.com',
  daterange: 'September 2019 - Present',
  points: [
    'I worked on the mobile app built with React Native. I also helped out with the backend built with Ruby on Rails.',
  ],
}, {
  company: 'Covidopoly',
  position: 'Intern',
